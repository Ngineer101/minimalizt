...
description: "API versioning and Swagger goes hand in hand when developing APIs. Learn how to easily set it up."
pubDate: "May 6 2021"
tags: ["asp-net-core", "dotnet", "swagger"]
heroImage: "/blog-cover-18.jpg"
---
...
![Enable XML documentation and suppress warning in .NET 5 API](/images/blog/swagger-api-versioning/project-properties.png)
...
![Swagger documentation example](/images/blog/swagger-api-versioning/swagger.png)
